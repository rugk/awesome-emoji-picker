...
* Wiki to translate: [wiki](https://github.com/rugk/awesome-emoji-picker/wiki)
* Sidebar file for adding language: [`_Sidebar` file](https://github.com/rugk/awesome-emoji-picker/wiki/_Sidebar/_edit)
